...
<div class="book-now-title">
    ...
    <div class="container">
            ...
            <div id="room-container">
                ...
                <div class="room-item" data-room-id="1">
                    ...
                    <select class="room-category" name="room-category[]">
                        <option value="Deluxe-Single">DELUXE SINGLE ROOM </option>
                        <option value="Deluxe-Double">DELUXE DOUBLE ROOM </option>
                        <option value="Deluxe-Triple">DELUXE TRIPLE ROOM </option>
                    </select>
		...
		<form class="booking-form" action="layabeachmail.php" method="POST" onsubmit="return validateForm()">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function disableGuestCounts(roomItem) {
            ...
            switch (roomCategory) {
                case 'Deluxe-Single':
                    addGuestCountOptions(guestCountSelect, 1, 1);
                    break;
                case 'Deluxe-Double':
                    addGuestCountOptions(guestCountSelect, 1, 2);
                    break;
                case 'Deluxe-Triple':
                    addGuestCountOptions(guestCountSelect, 1, 3);
                    break;
                default:
                    addGuestCountOptions(guestCountSelect, 1, 3);
                    break;
...
<script src="layabeach.js"></script>
</body>
</html>
