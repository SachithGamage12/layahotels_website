...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['send_email'])) {
    ...
    try {
        ...
        // Recipients
        $mail->setFrom($sender_email, 'Laya Beach Hotel');
        $mail->addAddress($guest_email); // Add a recipient

        // Email content
        $mail->isHTML(true);
        $mail->Subject = 'Booking Confirmation - Laya Beach Hotel';
            ...
            <body>
                <div class='container'>
                    ...
                    <div class='content'>
                        ...
                        <p>Thank you for choosing Laya Beach Hotel. We look forward to welcoming you!</p>
                    </div>
                    <div class='footer'>
                        <p>&copy; " . date('Y') . " Laya Beach Hotel. All rights reserved.</p>
                    </div>
                </div>
            </body>
            </html>
        ...
        echo "<script>
                ...
                window.location.href = 'layabeachadminpanel.php';
              </script>";
