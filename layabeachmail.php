...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    try {
        ...
        $mail->Password = 'lkhycxgvkuuzdrtp'; // SMTP password

        $mail->SMTPSecure = 'ssl';
        $mail->Port = 465;

        // Recipients
        $mail->setFrom('your_email@gmail.com', 'Laya Beach');
        $mail->addAddress('sachithgamage2310@gmail.com', 'Recipient Name'); // Add a recipient
        ...
        $emailBody = "
            ...
            <head>
                <style>
                    ...
                    h2 { color: #E6EC33; text-align: center; }
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO beachbookings (first_name, last_name, mobile_number, checkin_date, checkout_date, email_address,selected_rooms_html)
    ...
    if (mysqli_query($conn, $sql)) {
        echo '<script type="text/javascript">
            ...
            window.location.href = "layabeach.php";
        </script>';
    } else {
