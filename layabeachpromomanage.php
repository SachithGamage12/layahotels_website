...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if (isset($_POST['action'])) {
        ...
        if ($action == 'add') {
            ...
            if ($image) {
                $sql = "INSERT INTO beachpromo (image_url) VALUES ('$target')";
        ...
        elseif ($action == 'delete') {
            ...
            $sql = "SELECT image_url FROM beachpromo WHERE id=$id";
            ...
            if ($result->num_rows > 0) {
                ...
                $delete_sql = "DELETE FROM beachpromo WHERE id=$id";
...
<body>
    <div class="container">
        <div class="back-to-dashboard">
            <button onclick="location.href='layabeachadminpanel.php'">Back to Dashboard</button>
        </div>
