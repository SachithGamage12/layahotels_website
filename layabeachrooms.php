...
<nav class="navbar navbar-expand-lg navbar-light ">
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse position-absolute top-0 end-0 " id="navbarNav">
            <ul class="navbar-nav">
            <li class="nav-item">
    <a class="nav-link btn custom-btn-primary" href="layabeach.php">Home</a>
</li>
...
<div class="container mt-5">
    <div class="room-card" data-room-type="Deluxe-Single">
        <div id="carouselRoom1" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="img/sgl.jpeg" class="d-block w-100" alt="Room Image 1">
                </div>
                <div class="carousel-item">
                    <img src="img/sgl2.jpg" class="d-block w-100" alt="Room Image 2">
                </div>
                <div class="carousel-item">
                    <img src="img/sgl3.jpg" class="d-block w-100" alt="Room Image 3">
                </div>
                <div class="carousel-item">
                    <img src="img/sgl4.jpg" class="d-block w-100" alt="Room Image 4">
                </div>
        ...
        <div class="room-details">
            ...
            <a button class="btn btn-primary" href="layabeachbook.php">Book Now</button></a>
        </div>
    </div>

    <!-- Repeat similar structure for other room cards with respective IDs -->
    <div class="room-card" data-room-type="Deluxe-Double">
        <div id="carouselRoom2" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
            <div class="carousel-item active">
                    <img src="img/dbl.jpeg" class="d-block w-100" alt="Room Image 1">
                </div>
                <div class="carousel-item">
                    <img src="img/dbl2.jpg" class="d-block w-100" alt="Room Image 2">
                </div>
                <div class="carousel-item">
                    <img src="img/dbl3.jpeg" class="d-block w-100" alt="Room Image 3">
                </div>
                <div class="carousel-item">
                    <img src="img/dbl4.jpg" class="d-block w-100" alt="Room Image 4">
                </div>
                <!-- Add more images if needed -->
            </div>
    ...
    <div class="room-card" data-room-type="Deluxe-Triple">
        <div id="carouselRoom3" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="img/tpl.jpeg" class="d-block w-100" alt="Room Image 1">
                </div>
                <div class="carousel-item">
                    <img src="img/tpl2.jpg" class="d-block w-100" alt="Room Image 2">
                </div>
                <div class="carousel-item">
                    <img src="img/tpl3.jpg" class="d-block w-100" alt="Room Image 3">
                </div>
                <div class="carousel-item">
                    <img src="img/tpl4.jpg" class="d-block w-100" alt="Room Image 4">
                </div>
                <!-- Add more images if needed -->
            </div>
