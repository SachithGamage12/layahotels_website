    ...
    if (isset($_POST['action'])) {
        ...
        if ($action == 'add') {
            ...
            if ($description && $image) {
                $sql = "INSERT INTO beachservices (image_url, description) VALUES ('$target', '$description')";
        ...
        elseif ($action == 'update') {
            ...
            if ($image) {
                $sql = "UPDATE beachservices SET image_url='$target' WHERE id=$id";
            ...
            if (!empty($description)) {
                $sql = "UPDATE beachservices SET description='$description' WHERE id=$id";
        ...
        elseif ($action == 'delete') {
            ...
            $sql = "DELETE FROM beachservices WHERE id=$id";
