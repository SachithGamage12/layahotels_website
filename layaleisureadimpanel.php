...
<title>Laya Leisure | Admin Panel</title>
...
<div class="sidebar">
  <h2>Laya Leisure Admin Panel</h2>
  <ul>
  <li><a href="#"><i class="fas fa-tachometer-alt"></i> Dashboard</a></li>
  <li><a href="layaleisuremanagevideo.php"><i class="fas fa-video-camera"></i> Manage Video</a></li>
    <li><a href="admin_panel.php"><i class="fas fa-bed"></i> Manage Rooms</a></li>
    <li><a href="layaleisureupdateprice.php"><i class="fas fa-money-bill"></i> Update Prices</a></li>
    <li><a href="manage_service.php"><i class="fas fa-concierge-bell"></i> Manage Services</a></li>
    <li><a href="manage_gallery.php"><i class="fas fa-images"></i> Manage Gallery</a></li>
    <li><a href="promo_image.php"><i class="fas fa-tags"></i> Manage Promotions</a></li>
    <li><a href="layaleisureconfirmation.php"><i class="fas fa-hotel"></i> Confirm Booking</a></li>
    <li><a href="layaleisurebookingtable.php"><i class="fas fa-eye"></i> View Deleted Bookings</a></li>
    <li><a href="layaleisureuploadbooking.php"><i class="fas fa-upload"></i> Upload Bookings</a></li>
...
<div class="main-content">
  ...
  $total_bookings_sql = "SELECT COUNT(*) AS total FROM bookings WHERE booking_status != 'Cancelled'";
  ...
  ?>
    ...
    <div class="booking-type" style="background-color: darkgreen;">
      <?php
      include 'db_connect.php';
      $pending_bookings_sql = "SELECT COUNT(*) AS total FROM bookings WHERE booking_status = 'Pending'";
    ...
    <div class="booking-type" style="background-color: darkyellow;">
      <?php
      include 'db_connect.php';
      $confirmed_bookings_sql = "SELECT COUNT(*) AS total FROM bookings WHERE booking_status = 'Confirmed'";
    ...
    <div class="booking-type" style="background-color: darkred;">
      <?php
      include 'db_connect.php';
      $cancelled_bookings_sql = "SELECT COUNT(*) AS total FROM bookings WHERE booking_status = 'Cancelled'";
  ...
  <div class="table-container">
    ...
    <button type="button" class="print-button" onclick="openRecentBookingsPage()"  >Print Recent Bookings</button>
      ...
      <table id="bookingsTable">
        ...
        $reset_ai_sql = "ALTER TABLE bookings AUTO_INCREMENT = 1";
...
function openRecentBookingsPage() {
  window.open('layaleisurerecentbookings.php', '_blank');
}
