...
<div class="book-now-title">
    ...
    <div class="container">
            ...
            <div id="room-container">
                ...
                <div class="room-item" data-room-id="1">
                    ...
                    <select class="room-category" name="room-category[]">
                        <option value="deluxe-single">DELUXE SINGLE ROOM APARTMENT</option>
                        <option value="deluxe-double">DELUXE DOUBLE ROOM APARTMENT</option>
                        <option value="deluxe-triple">DELUXE TRIPLE ROOM APARTMENT</option>
                    </select>
		...
		<form class="booking-form" action="layaleisuremail.php" method="POST" onsubmit="return validateForm()">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        let roomCount = 1;
        const maxRooms = 20; // Maximum number of rooms
...
<script src="leisurebook.js"></script>
</body>
</html>
