...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    try {
        ...
        $mail->SMTPAuth = true;
        $mail->Username = 'info.layaleisure@gmail.com'; // SMTP username
        $mail->Password = 'hpzdcnwwjgkmaaut'; // SMTP password
        $mail->SMTPSecure = 'ssl';
        $mail->Port = 465;

        // Recipients
        $mail->setFrom('your_email@gmail.com', 'Laya Leisure');
        $mail->addAddress('info.layaleisure@gmail.com', 'Recipient Name'); // Add a recipient
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO bookings (first_name, last_name, mobile_number, checkin_date, checkout_date, email_address,selected_rooms_html)
    ...
    if (mysqli_query($conn, $sql)) {
        echo '<script type="text/javascript">
            ...
            window.location.href = "layaleisure.php";
        </script>';
    } else {
