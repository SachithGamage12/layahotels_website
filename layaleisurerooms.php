...
<nav class="navbar navbar-expand-lg navbar-light ">
    <div class="container-fluid">
        <a class="navbar-brand" href="#">
            <img src="layaleisureimages/logo.jpeg" alt="Logo" width="30" height="30" class="d-inline-block align-top">
            Laya Leisure
        </a>
        ...
        <div class="collapse navbar-collapse position-absolute top-0 end-0 " id="navbarNav">
            <ul class="navbar-nav">
            <li class="nav-item">
    <a class="nav-link btn custom-btn-primary" href="layaleisure.php">Home</a>
</li>
...
<div class="container mt-5">
    <div class="room-card" data-room-type="deluxe_single">
        <div id="carouselRoom1" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="layaleisureimages/single.jpg" class="d-block w-100" alt="Room Image 1">
                </div>
                <div class="carousel-item">
                    <img src="layaleisureimages/Single Room Apt/1.jpg" class="d-block w-100" alt="Room Image 2">
                </div>
                <div class="carousel-item">
                    <img src="layaleisureimages/Single Room Apt/2.jpg" class="d-block w-100" alt="Room Image 3">
                </div>
                <div class="carousel-item">
                    <img src="layaleisureimages/Single Room Apt/3.jpg" class="d-block w-100" alt="Room Image 4">
                </div>
        ...
        <div class="room-details">
            <h5>DELUXE SINGLE ROOM APARTMENT</h5>
            ...
            <a button class="btn btn-primary" href="layaleisurebook.php">Book Now</button></a>
        </div>
    </div>

    <!-- Repeat similar structure for other room cards with respective IDs -->
    <div class="room-card" data-room-type="deluxe_double">
        <div id="carouselRoom2" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="layaleisureimages/Dbl/2.jpg" class="d-block w-100" alt="Room Image 1">
                </div>
                <div class="carousel-item">
                    <img src="layaleisureimages/Dbl/1.jpg" class="d-block w-100" alt="Room Image 2">
                </div>
                <div class="carousel-item">
                    <img src="layaleisureimages/Dbl/3.jpg" class="d-block w-100" alt="Room Image 3">
                </div>
                <div class="carousel-item">
                    <img src="layaleisureimages/Dbl/4.jpg" class="d-block w-100" alt="Room Image 4">
                </div>
                <!-- Add more images if needed -->
            </div>
        ...
        <div class="room-details">
            <h5>DELUXE DOUBLE ROOM APARTMENT</h5>
    ...
    <div class="room-card" data-room-type="deluxe_triple">
        <div id="carouselRoom3" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="layaleisureimages/Tpl/3.jpg" class="d-block w-100" alt="Room Image 1">
                </div>
                <div class="carousel-item">
                    <img src="layaleisureimages/Tpl/1.jpg" class="d-block w-100" alt="Room Image 2">
                </div>
                <div class="carousel-item">
                    <img src="layaleisureimages/Tpl/2.jpg" class="d-block w-100" alt="Room Image 3">
                </div>
                <div class="carousel-item">
                    <img src="layaleisureimages/Tpl/5.jpg" class="d-block w-100" alt="Room Image 4">
                </div>
                <!-- Add more images if needed -->
            </div>
        ...
        <div class="room-details">
            <h5>DELUXE TRIPLE ROOM APARTMENT</h5>
