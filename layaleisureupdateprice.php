...
$sql = "SELECT room_type,basis_type, weekday, weekend, holiday FROM room_prices";
...
<body>
    ...
    <form action="update_price.php" method="POST">
        ...
        <select name="room_type" id="room_type" required>
            <option value="deluxe_single">DELUXE SINGLE</option>
            <option value="deluxe_double">DELUXE DOUBLE</option>
            <option value="deluxe_triple">DELUXE TRIPLE</option>
        </select>
