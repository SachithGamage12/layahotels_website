...
<div class="sidebar">
  <h2>Laya Safari Admin Panel</h2>
  <ul>
    <li><a href="#"><i class="fas fa-tachometer-alt"></i> Dashboard</a></li>
    <li><a href="layasafarimanagevideo.php"><i class="fas fa-video-camera"></i> Manage Video</a></li>
    <li><a href="layasafariaddroom.php"><i class="fas fa-bed"></i> Manage Rooms</a></li>
    <li><a href="layasafariupdatingprice.php"><i class="fas fa-money-bill"></i> Update Prices</a></li>
    <li><a href="layasafariservicemanage.php"><i class="fas fa-concierge-bell"></i> Manage Services</a></li>
    <li><a href="layasafarigallerymanage.php"><i class="fas fa-images"></i> Manage Gallery</a></li>
    <li><a href="layasafaripromomanage.php"><i class="fas fa-tags"></i> Manage Promotions</a></li>
    <li><a href="layasafariconfirmation.php"><i class="fas fa-hotel"></i> Confirm Booking</a></li>
    <li><a href="layasafaribookingtable.php"><i class="fas fa-eye"></i> View Deleted Bookings</a></li>
    <li><a href="layasafariuploadbookings.php"><i class="fas fa-upload"></i> Upload Bookings</a></li>
...
<div class="main-content">
  ...
  $total_bookings_sql = "SELECT COUNT(*) AS total FROM safaribookings WHERE booking_status != 'Cancelled'";
  ...
  ?>
    ...
    <div class="booking-type" style="background-color: darkgreen;">
      <?php
      include 'db_connect.php';
      $pending_bookings_sql = "SELECT COUNT(*) AS total FROM safaribookings WHERE booking_status = 'Pending'";
    ...
    <div class="booking-type" style="background-color: darkyellow;">
      <?php
      include 'db_connect.php';
      $confirmed_bookings_sql = "SELECT COUNT(*) AS total FROM safaribookings WHERE booking_status = 'Confirmed'";
    ...
    <div class="booking-type" style="background-color: darkred;">
      <?php
      include 'db_connect.php';
      $cancelled_bookings_sql = "SELECT COUNT(*) AS total FROM safaribookings WHERE booking_status = 'Cancelled'";
  ...
  <div class="table-container">
    <h2>Bookings</h2>&nbsp;&nbsp;
    <form method="POST" action="layasafariupdatingbooking.php">
    ...
    <button type="button" class="print-button" onclick="openRecentBookingsPage()"  >Print Recent Bookings</button>
      ...
      <table id="bookingsTable">
        ...
        $reset_ai_sql = "ALTER TABLE safaribookings AUTO_INCREMENT = 1";
        $conn->query($reset_ai_sql);
        
        $sql = "SELECT * FROM safaribookings ORDER BY id DESC LIMIT 10";
...
function openRecentBookingsPage() {
  window.open('layasafarirecentbooking.php', '_blank');
}
