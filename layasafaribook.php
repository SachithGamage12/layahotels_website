...
<div class="book-now-title">
    ...
    <div class="container">
		...
		<form class="booking-form" action="layasafarimails.php" method="POST" onsubmit="return validateForm()">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        let roomCount = 1;
        const maxRooms = 14; // Maximum number of rooms
...
<script src="layasafari.js"></script>
</body>
</html>
