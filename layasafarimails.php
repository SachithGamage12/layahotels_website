...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    try {
        ...
        // Recipients
        $mail->setFrom('your_email@gmail.com', 'Laya Safari');
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO safaribookings (first_name, last_name, mobile_number, checkin_date, checkout_date, email_address,selected_rooms_html)
    ...
    if (mysqli_query($conn, $sql)) {
        echo '<script type="text/javascript">
            ...
            window.location.href = "layasafari.php";
        </script>';
    } else {
