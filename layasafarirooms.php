...
<nav class="navbar navbar-expand-lg navbar-light ">
    <div class="container-fluid">
        <a class="navbar-brand" href="#">
            <img src="layasafariimages/logo.jpg" alt="Logo" width="30" height="30" class="d-inline-block align-top">
            Laya Waves
        </a>
        ...
        <div class="collapse navbar-collapse position-absolute top-0 end-0 " id="navbarNav">
            <ul class="navbar-nav">
            <li class="nav-item">
    <a class="nav-link btn custom-btn-primary" href="layasafari.php">Home</a>
</li>
...
<div class="container mt-5">
    <div class="room-card" data-room-type="deluxe sgl">
        <div id="carouselRoom1" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="layasafariimages/seaview2.jpg" class="d-block w-100" alt="Room Image 1">
                </div>
                <div class="carousel-item">
                    <img src="layasafariimages/seaview3.JPG" class="d-block w-100" alt="Room Image 2">
                </div>
                <div class="carousel-item">
                    <img src="layasafariimages/seaview4.jpg" class="d-block w-100" alt="Room Image 3">
                </div>
                <div class="carousel-item">
                    <img src="layasafariimages/seaview5.JPG" class="d-block w-100" alt="Room Image 4">
                </div>
        ...
        <div class="room-details">
            <h5>Deluxe Sea View SGL Room</h5>
            <p>How many pax can be here: 1 Pax</p>
            ...
            <a button class="btn btn-primary" href="layasafaribook.php">Book Now</button></a>
        </div>
    </div>
    <div class="room-card" data-room-type="deluxe dbl">
        <div id="carouselRoom1" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="layasafariimages/seaview2.jpg" class="d-block w-100" alt="Room Image 1">
        ...
        <div class="room-details">
            <h5>Deluxe Sea View DBL Room</h5>
    ...
    <div class="room-card" data-room-type="deluxe tpl">
        <div id="carouselRoom1" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="layasafariimages/seaview2.jpg" class="d-block w-100" alt="Room Image 1">
        ...
        <div class="room-details">
            <h5>Deluxe Sea View TPL Room</h5>
            <p>How many pax can be here: 3 Pax</p>
    ...
    <div class="room-card" data-room-type="jungle sgl">
        <div id="carouselRoom2" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
            <div class="carousel-item active">
                    <img src="layasafariimages/villa2.jpg" class="d-block w-100" alt="Room Image 1">
                </div>
                <div class="carousel-item">
                    <img src="layasafariimages/villa3.jpg" class="d-block w-100" alt="Room Image 2">
                </div>
                <div class="carousel-item">
                    <img src="layasafariimages/villa4.jpg" class="d-block w-100" alt="Room Image 3">
                </div>
                <div class="carousel-item">
                    <img src="layasafariimages/villa5.jpg" class="d-block w-100" alt="Room Image 4">
                </div>
                <!-- Add more images if needed -->
            </div>
    ...
    <div class="room-card" data-room-type="jungle dbl">
        <div id="carouselRoom2" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
            <div class="carousel-item active">
                    <img src="layasafariimages/villa2.jpg" class="d-block w-100" alt="Room Image 1">
    ...
    <div class="room-card" data-room-type="jungle tpl">
        <div id="carouselRoom2" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
            <div class="carousel-item active">
                    <img src="layasafariimages/villa2.jpg" class="d-block w-100" alt="Room Image 1">
