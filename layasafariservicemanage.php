...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if (isset($_POST['action'])) {
        ...
        elseif ($action == 'update') {
            ...
            if ($image) {
                $sql = "UPDATE safariservices SET image_url='$target' WHERE id=$id";
            ...
            if (!empty($description)) {
                $sql = "UPDATE safariservices SET description='$description' WHERE id=$id";
        ...
        elseif ($action == 'delete') {
            ...
            $sql = "DELETE FROM safariservices WHERE id=$id";
