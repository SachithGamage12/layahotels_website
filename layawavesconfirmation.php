...
<title>Laya Waves | Admin Panel - Confirmation</title>
...
<body>
<div class="back-link">
        <a href="layawavesadimpanel.php">Back to Dashboard</a>
    </div>
    &nbsp;
<div class="container">
  
  <h1 class="mb-4">Laya Waves Admin Panel - Confirmation</h1>
  ...
  <div class="row">
    ...
    <div class="col-right">
      ...
      if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['search'])) {
        ...
        $search_sql = "SELECT * FROM wavesbookings WHERE id = '$search' ORDER BY id DESC";
        ...
        if ($result === false) {
          ...
          echo "<form id='confirmation-email-form' method='POST' action='layawavesconfirmationmail.php'>";
          ...
          echo "<input type='email' id='sender_email' name='sender_email' class='form-control' value='layawaves@gmail.com' placeholder='Enter sender email' required>";
          echo "</div>";
          echo "<div class='form-group'>";
