...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['send_email'])) {
    ...
    try {
        ...
        // Recipients
        $mail->setFrom($sender_email, 'Laya Waves Hotel');
        $mail->addAddress($guest_email); // Add a recipient

        // Email content
        $mail->isHTML(true);
        $mail->Subject = 'Booking Confirmation - Laya Waves Hotel';
            ...
            <body>
                <div class='container'>
                    ...
                    <div class='content'>
                        ...
                        <p>Thank you for choosing Laya Waves Hotel. We look forward to welcoming you!</p>
                    </div>
                    <div class='footer'>
                        <p>&copy; " . date('Y') . " Laya Waves Hotel. All rights reserved.</p>
                    </div>
                </div>
            </body>
            </html>
        ...
        echo "<script>
                ...
                window.location.href = 'layawavesadimpanel.php';
              </script>";
