...
try {
    ...
    // Sender info
    $mail->setFrom('layawaves@gmail.com', 'Laya Waves Contact Form');
    ...
    // Email subject
    $mail->Subject = 'New Message from Laya Waves Contact Form';
    ...
    $emailBody = '
        ...
        <body>
            <div class="container">
                <h1>New Message from Laya Waves Contact Form</h1>
                <div class="message">
...
echo "<script>alert('{$statusMessage}'); window.location.href = 'layawaves.php';</script>";
?>
