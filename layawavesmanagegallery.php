...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if (isset($_POST['action'])) {
        ...
        if ($action == 'add') {
            ...
            $target_dir = "layawavesimages/"; // Directory where images will be uploaded
            ...
            if ($uploadOk == 0) {
                ...
                if (move_uploaded_file($_FILES["image"]["tmp_name"], $target)) {
                    ...
                    $sql = "INSERT INTO wavesgallery (image_url) VALUES ('$target')";
        ...
        elseif ($action == 'delete') {
            ...
            $sql = "SELECT image_url FROM wavesgallery WHERE id=$id";
            ...
            if ($result->num_rows > 0) {
                ...
                $delete_sql = "DELETE FROM wavesgallery WHERE id=$id";
