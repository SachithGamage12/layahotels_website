...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if (isset($_POST['action'])) {
        ...
        if ($action == 'add') {
            ...
            $target_dir = "layawavesimages/promo/";
            ...
            if ($image) {
                $sql = "INSERT INTO wavespromo (image_url) VALUES ('$target')";
        ...
        elseif ($action == 'delete') {
            ...
            $sql = "SELECT image_url FROM wavespromo WHERE id=$id";
            ...
            if ($result->num_rows > 0) {
                ...
                $delete_sql = "DELETE FROM wavespromo WHERE id=$id";
