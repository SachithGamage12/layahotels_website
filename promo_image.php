...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if (isset($_POST['action'])) {
        ...
        if ($action == 'add') {
            ...
            $target_dir = "layaleisureimages/promo/";
            ...
            if ($image) {
                $sql = "INSERT INTO promo_images (image_url) VALUES ('$target')";
        ...
        elseif ($action == 'delete') {
            ...
            $sql = "SELECT image_url FROM promo_images WHERE id=$id";
            ...
            if ($result->num_rows > 0) {
                ...
                $delete_sql = "DELETE FROM promo_images WHERE id=$id";
